...
export default function VolunteerResponseDetailPage() {
    ...
    const fetchResponse = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setResponse(null); // Ensure response is null on error
        }
      } catch (error) {
    ...
    return (
      <div className="text-center py-20">
        <h2 className="text-xl font-bold text-gray-900">
          Response Not Found or Forbidden
        </h2>
        <p className="text-gray-500 mt-2 mb-6">
          You may not have permission to view this response, or it does not
          exist.
        </p>
        <Link
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Link
            href={`/volunteer/responses/${id}/edit`}
      ...
      {/* Meta Info Card */}
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-wrap gap-8 items-center">
